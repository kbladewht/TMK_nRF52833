...
#define MTXP17 NRF_GPIO_PIN_MAP(0, 6)
#define MTXP18 NRF_GPIO_PIN_MAP(0, 26)
#define MTXP19 NRF_GPIO_PIN_MAP(1, 9)
#define MTXP20 NRF_GPIO_PIN_MAP(0, 5)
#define MTXP21 NRF_GPIO_PIN_MAP(0, 30)
